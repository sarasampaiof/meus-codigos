...
print(f"Você comprou um produto {produto} por R${preço:.2f} e entregou ao vendedor R${valor_entregue:.2f} em dinheiro. Você vai receber R${troco:.2f} de troco. Volte sempre!")
